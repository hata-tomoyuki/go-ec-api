...
type Querier interface {
	...
	DeleteAddress(ctx context.Context, arg DeleteAddressParams) (Address, error)
	...
	ListProductsByCategory(ctx context.Context, categoryID int64) ([]ListProductsByCategoryRow, error)
